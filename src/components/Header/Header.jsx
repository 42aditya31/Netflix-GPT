    ...
    <div className="absolute top-0 left-0 flex flex-row justify-between  w-full bg-gradient-to-b from-black z-50">
      ...
      {user && (
        <div className="p-8 flex">
          <button onClick={handleGptSearch} className="bg-purple-500 cursor-pointer hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-md shadow-md mx-5 transition duration-300 ease-in-out">
